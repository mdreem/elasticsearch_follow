...
class TestFollower:
    ...
    def test_follower_returns_added_entry(self):
        ...
        es.search.return_value = generate_basic_query_response('id_1', 'line1', REFERENCE_TIME)
    ...
    def test_follower_with_processor_returns_added_entry(self):
        ...
        follower = elasticsearch_follow.Follower(es_follow, 'some_index', 120, processor=processor)
